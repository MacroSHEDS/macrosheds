...
test_that('the correct domains are loaded in', {
    ...
    results_hbef <- macrosheds::ms_load_product(macrosheds_root = 'data/ms_test/', 
                                prodname = 'discharge',
                                domains = c('hbef'),
                                warn = F) %>%
        pull(site_code) %>%
    ...
    results_2_doms <- macrosheds::ms_load_product(macrosheds_root = 'data/ms_test/', 
                                                  prodname = 'discharge',
...
test_that('filter_vars filters the correct vars', {
    results_vars <- macrosheds::ms_load_product(macrosheds_root = 'data/ms_test/', 
                                                prodname = 'stream_chemistry',
