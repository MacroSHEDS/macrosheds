...
test_that('error is thrown for non sparial products', {
    expect_error(macrosheds::ms_load_spatial_products(macrosheds_root = 'data/ms_test',
...
test_that('one site_codes shapefiles is loaded', {
    ...
    expect_s3_class(macrosheds::ms_load_spatial_products(macrosheds_root = 'data/ms_test',
                                                         spatial_product = 'ws_boundary',
                                                         site_codes = 'w1'),
                    c('sf', 'data.frame'))
    
    expect_equal(nrow(macrosheds::ms_load_spatial_products(macrosheds_root = 'data/ms_test',
                                                           spatial_product = 'ws_boundary',
                                                           site_codes = 'w1')), 1)
})
...
test_that('ms_root must be correct', {
    expect_error(macrosheds::ms_load_spatial_products(macrosheds_root = 'fake_fake',
