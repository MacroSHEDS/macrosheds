...
#'
#' Remove the two-letter prefixes from MacroSheds variable codes. Retained for
#' legacy use, but will be removed in a later version. See details.
#'
#' @author Spencer Rhea
...
#' @details In version 1 of the MacroSheds dataset, variable codes all included a two-letter prefix to denote the
...
ms_drop_var_prefix <- function(x){
    ...
    warning('Since version 2 of the MacroSheds dataset, variable prefixes have been replaced by a "grab_sample" column. ms_drop_var_prefix_ is deprecated and will be removed in a later version of this package. Please use ms_download_core_data to upgrade to dataset v2.')
