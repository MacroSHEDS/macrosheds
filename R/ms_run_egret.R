...
#' @param stream_chemistry \code{data.frame} in MacroSheds format (see [MacroSheds dataset](https://doi.org/10.6084/m9.figshare.c.5621740)).
...
#' @param discharge \code{data.frame} in MacroSheds format (see [MacroSheds dataset](https://doi.org/10.6084/m9.figshare.c.5621740)).
