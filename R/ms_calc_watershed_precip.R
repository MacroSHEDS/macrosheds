...
#'    File or directory must represent a dataset in MacroSheds format (see [MacroSheds documentation](https://doi.org/10.6084/m9.figshare.c.5621740) for definitions),
...
#'    and pchem are supplied) to \code{out_path} as feather files in MacroSheds format (see [MacroSheds documentation](https://doi.org/10.6084/m9.figshare.c.5621740)).
