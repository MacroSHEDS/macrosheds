...
#'    File or directory must represent a dataset in MacroSheds format (see [MacroSheds documentation](EDI link pending) for definitions),
...
#'    and pchem are supplied) to \code{out_path} as feather files in MacroSheds format (see [MacroSheds documentation](EDI link pending)).
