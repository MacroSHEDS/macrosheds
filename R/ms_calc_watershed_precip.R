...
#'    and pchem are supplied) to \code{out_path} as feather files in MacroSheds format (see [MacroSheds EDI](https://portal.edirepository.org/nis/mapbrowse?scope=edi&identifier=1262)).
