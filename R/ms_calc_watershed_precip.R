...
#' @param precip optional \code{date.frame} or path to a directory containing feather files.
#'    File or directory must represent a dataset in MacroSheds format (see PLACEHOLDER0 for definitions),
...
#' @param pchem optional \code{date.frame} or path to a directory containing feather files.
#'    File or directory must represent a dataset in MacroSheds format (see PLACEHOLDER0 for definitions),
#'    containing precipitation chemistry time series. Expects daily data in mg/L, mEq/L, or mmol/L. A \code{tibble} of precip concentration, in
#'    MacroSheds format, can be generated by [ms_load_product()]. If \code{pchem} is
