...
To get information on our target variable, Nitrate, we can use `ms_download_var_catalog`. This function will load in a dataframe describing what sites record what variables, for how long, the average observations per day, and more.
...
This is a pretty long list, let's do a siple text search to see what variables start with "Nitrate"
...
There's a ton of results here, but I can see Nitrate, and it's variable code 'NO3_N'. 
