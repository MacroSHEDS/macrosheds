...
Our first goal is to **identify sites we might want to pull data from**. To get more information about MacroSheds sites, we will use the function `ms_download_site_data`, which loads a tibble of MacroSheds site metadata. 
