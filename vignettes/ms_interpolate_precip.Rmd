...
vignette: >
  %\VignetteIndexEntry{Precipitation Interpolation}
...
?poudre_ws
```
![poudre_ws](files/ms_interpolate_precip_files/figure-markdown_strict/unnamed-chunk-7-1.png)
...
```r
poudre_plot <- ggplot(pourdre_precip, aes(datetime, val)) +
    geom_line() +
